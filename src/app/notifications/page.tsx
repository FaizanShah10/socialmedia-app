        ...
        <CardHeader className="border-b">
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center gap-2">
              Notifications
              <span className="w-6 h-6 bg-white rounded-full text-black text-sm flex items-center justify-center">
                {notifications.filter((n) => !n.read).length}
              </span>
            </CardTitle>
            <span className="text-sm text-muted-foreground cursor-pointer neue-roman tracking-wide">
              Mark All as Read
            </span>
          </div>
        </CardHeader>
